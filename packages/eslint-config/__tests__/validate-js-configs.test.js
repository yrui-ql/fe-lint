...
describe('Validate JS configs', () => {
  it('Validate @yrui/eslint-config', async () => {
  ...
  it('Validate @yrui/eslint-config/es5', async () => {
  ...
  it('Validate @yrui/eslint-config/vue', async () => {
  ...
  it('Validate @yrui/eslint-config/essential', async () => {
  ...
  it('Validate @yrui/eslint-config/essential/es5', async () => {
  ...
  it('Validate @yrui/eslint-config/essential/react', async () => {
  ...
  it('Validate @yrui/eslint-config/essential/vue', async () => {
  ...
  it('Validate @yrui/eslint-config/node', async () => {
