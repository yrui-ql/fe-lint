...
describe('Validate TS configs', () => {
  it('Validate @yrui/eslint-config/typescript', async () => {
  ...
  it('Validate @yrui/eslint-config/typescript/vue', async () => {
  ...
  it('Validate @yrui/eslint-config/essential/typescript', async () => {
  ...
  it('Validate @yrui/eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate @yrui/eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate @yrui/eslint-config/typescript/node', async () => {
